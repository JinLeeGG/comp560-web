...
A significant component of your grade for COMP560 will be determined by your _activity log_. Your activity log is a private Teams channel in which the only participants are you and the instructors. Please create your own activity log in our [Team](https://teams.microsoft.com/l/team/19%3A_GsPmsPAHyNRNM16rkLYR2tZH0CmPZ6ZFAAhhKzwj2A1%40thread.tacv2/conversations?groupId=327c5cf0-93db-45ce-be36-d648004b666f&tenantId=6232b055-76b9-4c13-9b88-b562ae7db6fb) when you begin working on the project. Guidance:
* Please name your activity log channel "`Your Name activity log`" e.g. "`John MacCormick activity log`". Make sure it is a private channel and give access to the three instructors.
* The activity log should record essentially everything you do for the project. This includes time you spend:
  - reading background materials, literature and documentation;
  - writing code, debugging, conducting experiments, producing results;
